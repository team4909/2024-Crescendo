...
public class Rev_2Arm extends SubsystemBase {
  ...
  private TalonFX l_joint1 = new TalonFX(13, "CANivore1");
  private TalonFX l_joint2 = new TalonFX(15, "CANivore1");
  private TalonFX r_joint1 = new TalonFX(14, "CANivore1");
  private TalonFX r_joint2 = new TalonFX(16, "CANivore1");

  final VelocityVoltage m_request = new VelocityVoltage(10).withSlot(0);
  ...
  public Rev_2Arm() {
    ...
    GearRatio1 = 17/48;
    GearRatio2 = 17/36;
    Motor1Vel = AngularVelocity/GearRatio1;
    Motor2Vel = AngularVelocity/GearRatio2;
    ...
    l_joint2Configs.kV = 0.12;
    l_joint2Configs.kP = 0.1;
  ...
  public void periodic() {
    ...
    System.out.println(l_joint1.getPosition());
  ...
  public Command Rotate() {
    return new ParallelCommandGroup(
      new InstantCommand(()-> l_joint1.setControl(m_request.withVelocity(Motor1Vel))),
      new InstantCommand(()-> l_joint2.setControl(m_request.withVelocity(Motor2Vel))));
